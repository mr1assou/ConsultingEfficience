                    ...
                    <div className="container">
                        <div className="row justify-content-between align-items-center g-4">
                            <div className="col-lg-6 col-md-12 mb-5 mb-lg-0">
                                <div className="about-content-left wow fadeInLeft delay-0-2s">
                                    <h3
                                        style={{
                                    ...
                                    >
                                        Un organisme de formation qui conjugue excellence commerciale et développement de soi
                                    </h3>
                            ...
                            <div className="col-lg-5 col-md-12">
                                <div className="about-content-right wow fadeInRight delay-0-2s">
                                    <div className="section-title mb-4">
                                        ...
                                        >
                                            ...
                                            <i className="fas fa-asterisk" style={{ color: '#307926', marginLeft: '8px' }} />
                                        </h5>
