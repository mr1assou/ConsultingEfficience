    ...
    return (
        <>
            <section className="video-area rel z-1">
                ...
                <div className="container ">
                    <div className="video-inner pt-110 rpt-60 text-center" style={{ backgroundImage: 'url(assets/images/hero/hero-main.png)' }}>
                        ...
                        <div className="row rpt-15 align-items-center">
                            ...
                            <div className="col-xl-5 col-4 text-start wow fadeInRight delay-0-2s">
                                <span className="video-text">Consulting</span>
                            </div>
                        </div>
